...
var Main = React.createClass({
  ...
  _setSearchFeilds: function(programs) {
    this.setState({ searchTerms: [programs] });
  },
    ...
    return (
      ...
      <div className="container" style={ {backgroundColor: "white", borderStyle: "solid", borderWidth: "1px"} }>
        ...
        <div className="page-header">
          <h1 className="text-center"><img style={ {width: "70%"} } src="img/college-pennant.png" alt="Times Machine"/></h1>
          <h2 className="text-center" style={ {marginTop: "-12px"} }><b><i>College Query Search</i></b></h2>
          <h4 className="text-center">Select a college search criteria.</h4>
        </div>
